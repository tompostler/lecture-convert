namespace UnlimitedInf.LectureConvert
{
    ...
    /// </summary>
    internal class Prepare : IDisposable
    {
        ...
        /// <summary>
        /// Figure out which lectures we actually need to prepare for consumption.
        /// </summary>
        /// <param name="allLectures"></param>
        public Prepare(ICollection<LectureInfo> allLectures)
        {
            // Check for the dir
            ...
            // Only prepare the necessary lectures
